...
public class UpgradeSoulbound extends ItemSimple implements IUpgrade
{
    public UpgradeSoulbound()
    {
        super(VSBRegistryNames.itemUpgradeSoulbound, 1);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("vsb.txt.upgrade.soulbound.desc").split("\\|")));
    }
