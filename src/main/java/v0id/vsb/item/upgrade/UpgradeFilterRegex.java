...
public class UpgradeFilterRegex extends ItemSimple
{
    public UpgradeFilterRegex()
    {
        super(VSBRegistryNames.itemUpgradeFilterRegex, 1);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        if (playerIn instanceof EntityPlayerMP)
        {
            ...
            VSBUtils.openContainer((EntityPlayerMP) playerIn, new ContainerFilterRegex(playerIn.inventory, is, slot));
            VSBNet.sendOpenGUI(playerIn, handIn == EnumHand.MAIN_HAND ? playerIn.inventory.currentItem : 40, true, slot, EnumGuiType.FILTER_REGEX);
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable NBTTagCompound nbt)
    {
        ...
        {
            private final FilterRegex cap = new FilterRegex();
