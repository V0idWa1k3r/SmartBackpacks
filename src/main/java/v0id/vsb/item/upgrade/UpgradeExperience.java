...
public class UpgradeExperience extends ItemSimple implements IUpgrade
{
    public UpgradeExperience()
    {
        super(VSBRegistryNames.itemUpgradeExperience, 1);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("vsb.txt.upgrade.experience.desc").split("\\|")));
    }
