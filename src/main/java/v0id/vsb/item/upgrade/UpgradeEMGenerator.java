...
public class UpgradeEMGenerator extends ItemSimple implements IUpgrade
{
    public UpgradeEMGenerator()
    {
        super(VSBRegistryNames.itemUpgradeEMGenerator, 1);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("vsb.txt.upgrade.generator_em.desc").split("\\|")));
    }
    ...
    {
        backpack.getSelfAsCapability().getEnergyStorage().receiveEnergy(VSBCfg.emUpgradeFEPerPulse, false);
    }
