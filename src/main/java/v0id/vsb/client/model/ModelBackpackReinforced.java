 ...
 */
public class ModelBackpackReinforced extends ModelBase {
    public ModelRenderer shape1;
    public ModelRenderer shape2;
    public ModelRenderer shape3;
    public ModelRenderer shape4;

    public ModelBackpackReinforced() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.shape3 = new ModelRenderer(this, 28, 0);
        this.shape3.mirror = true;
        this.shape3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.shape3.addBox(4.0F, -4.0F, -1.0F, 2, 5, 4, 0.0F);
        ...
        this.shape4.addBox(-6.0F, -4.0F, -1.0F, 2, 5, 4, 0.0F);
    }
